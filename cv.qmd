...
Anonymized Enterprise Data Platform Engagement
...
- Coordinate transition planning/execution for **Databricks → Snowflake** while maintaining daily Spark/BI workloads with several terabytes of sensor data.
...
- Open-sourced **`[ts-agents](https://github.com/fnauman/ts-agents)` (PoC)**: a framework for autonomous time series agents; applied it to machine activity recognition from sensor data, demonstrating that classifier-heavy activity recognition workflows can be replaced by agent-driven analysis.

...
[![Email](https://raw.githubusercontent.com/FortAwesome/Font-Awesome/6.x/svgs/regular/envelope.svg){width=24px title="Email" .social-icon}](mailto:farrukh.nauman@inertialrange.com)
[![CV](https://raw.githubusercontent.com/FortAwesome/Font-Awesome/6.x/svgs/regular/file-pdf.svg){width=24px title="Download CV" .social-icon}](assets/FarrukhNauman_brokers.pdf)
:::
:::
...
I help organizations leverage cutting-edge AI for measurable business impact. 

- 🤖 **LLMs**: Custom LLM and generative AI systems for synthetic data generation and smart assistants.
- 🔍 **Computer Vision**: Design and deployment of computer vision systems for automated process optimization and inspection.
- 📊 **Time Series**: Development of time series models for classification, anomaly detection and forecasting.

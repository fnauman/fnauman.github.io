...
Three things make this layer trustworthy.
...
When I review a migration's test suite, these are the questions I want the suite to be able to answer without me reading the code.
...
That is what an oracle looks like once you actually have to maintain it. Not a number you compare against, but a structured set of artifacts whose internal consistency is itself a test. Get that right and the rest of the migration is mostly typing.

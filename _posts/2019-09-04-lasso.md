...
For a simple worked out example with boston housing dataset, see [this](https://chrisalbon.com/machine_learning/linear_regression/effect_of_alpha_on_lasso_regression/). 

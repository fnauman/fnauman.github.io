---
title: "Fast & Accurate Time Series Classification for Production"
...
og:
  title: "Fast & Accurate Time Series Classification: Research to Production"
...
Many real‑world systems need accurate, low‑latency models on constrained hardware (edge, IoT, embedded). Deep models can be heavy to train and serve; feature‑based methods deliver strong accuracy with simpler, faster inference.
...
1. Baseline with a standard variant
2. Optimize feature count and classifier for your constraints
3. Integrate via scikit‑learn pipeline and standard tooling
4. Deploy to edge or cloud as needed
...
pipeline = Pipeline([
    ...
    ('features', MiniROCKET(num_features=10_000)),
